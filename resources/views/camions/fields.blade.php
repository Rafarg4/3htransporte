...
<div class="form-group col-sm-4">
    ...
    {!! Form::select('id_chofer', $choferes, null, ['class' => 'form-control select2', 'id' => 'id_chofer', 'style' => 'width: 100%', 'placeholder' => 'Seleccione un chofer', 'required' => 'required']) !!}
</div>
...
<style>
    #id_chofer + .select2-container .select2-selection--single {
        height: calc(1.5em + .75rem + 2px);
        border: 1px solid #ced4da;
        border-radius: .25rem;
    }
    #id_chofer + .select2-container .select2-selection--single .select2-selection__rendered {
        line-height: calc(1.5em + .75rem);
        padding-left: .75rem;
        color: #495057;
    }
    #id_chofer + .select2-container .select2-selection--single .select2-selection__arrow {
        height: calc(1.5em + .75rem);
        right: 6px;
    }
    #id_chofer + .select2-container--default.select2-container--focus .select2-selection--single,
    #id_chofer + .select2-container--default .select2-selection--single:focus {
        border-color: #80bdff;
        outline: 0;
